...
print(Solution().mostCommonWord("Bob", banned=[]))
print(Solution().mostCommonWord("Bob hit a ball, the hit BALL flew far after it was hit.", banned=["hit"]))
